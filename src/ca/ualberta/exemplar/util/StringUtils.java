...
public class StringUtils {
	...
	public static String convertToAscii(String text){
		...
		return convertToAscii(chars, chars.length);
	}

	// Shamelessly copied from Lucene's ASCIIFoldingFilter class.
	public static String convertToAscii(char [] input, int length){
